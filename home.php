            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="mb-4 mt-4 text-center">
                        ...
                        <button type="button" class="btn btn-success mt-2"><i class="ri-mail-line me-1"></i> Email us
                            your question</button>
                        <button type="button" class="btn btn-info mt-2 ms-1"><i class="ri-twitter-line me-1"></i> Send
                            us a tweet</button>
                    </div>
                </div><!-- end col -->
            </div><!-- end row -->
                                ...
                                <div class="col-md-4">
                                    <div>
                                        ...
                                        <p class="faq-answer mb-4">We receive up to 20 enquiries per week from
                                            ...
                                            right away, all enquiries are checked and answered in chronological order.
                                        </p>
                                    </div>
                                </div> <!-- end col -->
                                <div class="col-md-4">
